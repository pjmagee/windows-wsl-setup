...
gh skill install pjmagee/windows-wsl-setup windows-wsl-setup --scope user --agent claude-code
gh skill install pjmagee/windows-wsl-setup windows-wsl-setup --scope user --agent github-copilot
gh skill install pjmagee/windows-wsl-setup windows-wsl-setup --scope user --agent codex
```
...
```
/plugin marketplace add pjmagee/windows-wsl-setup
/plugin install windows-wsl-setup@windows-wsl-setup
```

**Paste only:** ask the agent to read  
https://raw.githubusercontent.com/pjmagee/windows-wsl-setup/main/skills/windows-wsl-setup/SKILL.md
...
5. Password manager first, then the browser, then the rest.
